...
class RepositorioMovimentacao:
    ...
    @staticmethod
    def buscar_movimentacao_tipo(tipo, orcamento_id): #Busca de uma movimentação através do tipo
        return Movimentacao.objects.filter(tipo=tipo, orcamento_id=orcamento_id)
